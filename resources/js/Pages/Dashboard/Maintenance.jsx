...
export default function Maintenance({ maintenances, vehicles, userRole }) {
                            ...
                            <form onSubmit={submitAction} className="p-6 flex flex-col gap-4">
                                <p className="text-gray-300 text-sm mb-2">
                                    {actionType === 'SubmitReview' ? (
                                        <>You are about to <strong>forward</strong> this maintenance request (₦{Number(selectedMaintenance?.cost).toLocaleString()}) from {selectedMaintenance?.vehicle?.license_plate} to the <strong>Super Admin</strong> for review.</>
                                    ) : (
